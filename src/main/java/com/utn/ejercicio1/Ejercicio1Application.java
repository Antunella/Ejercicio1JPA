...
// Recuperar el objeto Persona desde la base de datos
			...
			if (personaRecuperada != null) {
				...
				System.out.println("Edad: " + personaRecuperada.getEdad()); System.out.println("----------------------------------------");
				personaRecuperada.mostrarDomicilios();
				System.out.println(" ------ finalicé desde persona"); }
			System.out.println("...... Muestro la bidireccionalidad......."); // Recuperar los domicilios de la base de datos
			List<Domicilio> domiciliosRecuperados =
					domicilioRepository.findAll();
			if (domiciliosRecuperados!= null) {
// Iterar a través de los domicilios y mostrar información
				System.out.println("Información de los Domicilios:"); for (Domicilio domicilio : domiciliosRecuperados) {
					System.out.println("Domicilio en " + domicilio.getCalle() + " " + domicilio.getNumero());
					System.out.println("Perteneciente a " + domicilio.getPersona().getNombre() + " " +
							domicilio.getPersona().getApellido());
				}
			} };
